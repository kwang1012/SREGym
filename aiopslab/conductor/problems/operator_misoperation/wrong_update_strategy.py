...
################## Detection Problem ##################
class K8SOperatorWrongUpdateStrategyDetection(K8SOperatorWrongUpdateStrategyBaseTask, DetectionTask):
    def __init__(self):
...
class K8SOperatorWrongUpdateStrategyLocalization(K8SOperatorWrongUpdateStrategyBaseTask, LocalizationTask):
    def __init__(self):
        K8SOperatorWrongUpdateStrategyBaseTask.__init__(self)
