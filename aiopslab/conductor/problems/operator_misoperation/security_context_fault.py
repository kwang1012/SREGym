...
from aiopslab.conductor.evaluators.quantitative import *
from aiopslab.conductor.tasks import *
...
################## Detection Problem ##################
class K8SOperatorSecurityContextFaultDetection(K8SOperatorSecurityContextFaultBaseTask, DetectionTask):
    def __init__(self):
...
class K8SOperatorSecurityContextFaultLocalization(K8SOperatorSecurityContextFaultBaseTask, LocalizationTask):
    def __init__(self):
        K8SOperatorSecurityContextFaultBaseTask.__init__(self)
