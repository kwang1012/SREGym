...
-Run the benchmark in tmux sessions on each node
-Run an automatic submission script on each node in tmux sessions
...
2.. **Your SSH key is added to your SSH agent** on your local machine

## Required Files:
1. Make sure you have a nodes.txt file in this directory, with each line being a cloudlab node.
    ex: 
